        ...
        return function (t) {
            ...
            Handler.extend({
                ...
                object: function (t) {
                    ...
                    if (void 0 != t.rule.min)
                        for (e = Util.keys(t.template), e = (e = Random.shuffle(e)).slice(0, t.rule.count), i = 0; i < e.length; i++) a = (r = e[i]).replace(Constant.RE_KEY, "$1"), t.context.path.push(a), t.context.templatePath.push(r), u[a] = Handler.gen(t.template[r], r, {
                            path: t.context.path,
                            templatePath: t.context.templatePath,
                            currentContext: u,
                            templateCurrentContext: t.template,
            ...
            var n = {
                extend: function () {
                    ...
                    for (1 === l && (i = this, u = 0); l > u; u++)
                        if (t = arguments[u])
                            for (e in t) r = i[e], i !== (a = t[e]) && void 0 !== a && (n.isArray(a) || n.isObject(a) ? (n.isArray(a) && (o = r && n.isArray(r) ? r : []), n.isObject(a) && (o = r && n.isObject(r) ? r : {}), i[e] = n.extend(o, a)) : i[e] = a);
                    return i
                },
                each: function (t, e, n) {
                    var r, a;
                        ...
                        parse: function (e) {
                            ...
                            function s() {
                                ...
                                return t = pn, null !== (n = function () {
                                    ...
                                    if (t = pn, null === (s = pn, 94 === e.charCodeAt(pn) ? (f = B, pn++) : (f = null, 0 === xn && l(G)), null !== f && (fn = s, f = X()), null === f ? (pn = s, s = f) : s = f, n = s) && (n = I), null !== n)
                                        if (r = pn, xn++, a = p(), xn--, null === a ? r = I : (pn = r, r = O), null !== r) {
                            ...
                            function c() {
                                ...
                                return L = pn, 40 === e.charCodeAt(pn) ? (j = wt, pn++) : (j = null, 0 === xn && l(Ct)), null !== j ? (null === (Z = pn, e.substr(pn, 2) === St ? (Q = St, pn += 2) : (Q = null, 0 === xn && l(Tt)), null !== Q && null !== (tt = s()) ? (fn = Z, null === (Q = Ht(tt)) ? (pn = Z, Z = Q) : Z = Q) : (pn = Z, Z = O), N = Z) && null === ($ = pn, e.substr(pn, 2) === qt ? (J = qt, pn += 2) : (J = null, 0 === xn && l(Dt)), null !== J && null !== (V = s()) ? (fn = $, null === (J = Ft(V)) ? (pn = $, $ = J) : $ = J) : (pn = $, $ = O), N = $) && null === (K = pn, e.substr(pn, 2) === _t ? (W = _t, pn += 2) : (W = null, 0 === xn && l(Mt)), null !== W && null !== (Y = s()) ? (fn = K, null === (W = Pt(Y)) ? (pn = K, K = W) : K = W) : (pn = K, K = O), N = K) && (U = pn, null !== (X = s()) && (fn = U, X = At(X)), null === X ? (pn = U, U = X) : U = X, N = U), null !== N ? (41 === e.charCodeAt(pn) ? (z = kt, pn++) : (z = null, 0 === xn && l(Et)), null !== z ? (fn = L, null === (j = Rt(N)) ? (pn = L, L = j) : L = j) : (pn = L, L = O)) : (pn = L, L = O)) : (pn = L, L = O), null === (t = L) && null === (t = function () {
                                    var t, n, r, a, o;
                                    if (xn++, t = pn, 91 === e.charCodeAt(pn) ? (n = Ot, pn++) : (n = null, 0 === xn && l(It)), null !== n)
                                        if (94 === e.charCodeAt(pn) ? (r = B, pn++) : (r = null, 0 === xn && l(G)), null === r && (r = I), null !== r) {
                            ...
                            function f() {
                                var t, n, r;
                                if (t = pn, n = [], xt.test(e.charAt(pn)) ? (r = e.charAt(pn), pn++) : (r = null, 0 === xn && l(yt)), null !== r)
                                    for (; null !== r;) n.push(r), xt.test(e.charAt(pn)) ? (r = e.charAt(pn), pn++) : (r = null, 0 === xn && l(yt));
                                else n = O;
                            ...
                            function M() {
                                ...
                                if (t = pn, e.substr(pn, 2) === Ve ? (n = Ve, pn += 2) : (n = null, 0 === xn && l(Ze)), null !== n) {
                                    if (r = [], Qe.test(e.charAt(pn)) ? (a = e.charAt(pn), pn++) : (a = null, 0 === xn && l(tn)), null !== a)
                                        for (; null !== a;) r.push(a), Qe.test(e.charAt(pn)) ? (a = e.charAt(pn), pn++) : (a = null, 0 === xn && l(tn));
                                    else r = O;
                            ...
                            function P() {
                                ...
                                if (t = pn, e.substr(pn, 2) === nn ? (n = nn, pn += 2) : (n = null, 0 === xn && l(rn)), null !== n) {
                                    if (r = [], an.test(e.charAt(pn)) ? (a = e.charAt(pn), pn++) : (a = null, 0 === xn && l(on)), null !== a)
                                        for (; null !== a;) r.push(a), an.test(e.charAt(pn)) ? (a = e.charAt(pn), pn++) : (a = null, 0 === xn && l(on));
                                    else r = O;
            ...
            r._settings = {
                ...
                open: function (t, e, n, o, s) {
                    ...
                    if (p) this.match = !0, this.custom.template = p, this.readyState = r.OPENED, this.dispatchEvent(new Event("readystatechange"));
                    else {
                        var f = function () {
                            function t() {
                                try {
