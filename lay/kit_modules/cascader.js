...
layui.define(["layer", "utils", "axios", "laytpl"], function (e) {
    var l = "cascader", a = layui.jquery, i = layui.layer, n = layui.utils, s = layui.lodash, t = layui.laytpl, c = {
        ...
        renderHTML: function (e) {
            var l = e._elem, a = e.data, i = e.callback, s = e.filter, c = ['<ul class="kit-cascader-list">'];
        ...
        function e() {
            _classCallCheck(this, e), this.config = {filter: n.randomCode()}
        }
        ...
        return _createClass(e, [{
                ...
                a.extend(!0, i, e), void 0 !== i.elem ? n.isString(i.elem) && 0 === a(i.elem).length ? console.warn("Cascader Error:请为cascader绑定elem.") : n.isObject(i.elem) && 0 === i.elem.length ? console.warn("Cascader Error:请为cascader绑定elem.") : (i.elem = n.isString(i.elem) ? a(i.elem) : i.elem, i.elem.length > 1 ? console.warn("Cascader Error:一次只能渲染一个Cascader.") : c.renderHTML({
                    ...
                    data: [{
                        ...
                        children: [{
                            ...
                            value: "440100",
                            label: "广州市",
                            children: [{id: 3, pid: 2, value: "440106", label: "天河区"}, {
                                id: 4,
                                pid: 2,
                                value: "440104",
                                label: "越秀区"
                            }, {id: 5, pid: 2, value: "440105", label: "海珠区"}]
                        }]
                    }, {
                        id: 11,
                        pid: 0,
                        ...
                        children: [{
                            ...
                            value: "510100",
                            label: "成都市",
                            children: [{id: 33, pid: 22, value: "510101", label: "市辖区"}, {
                                id: 44,
                                pid: 22,
                                value: "510104",
                                label: "锦江区"
                            }, {id: 55, pid: 22, value: "510105", label: "青羊区"}]
                        }]
                    }],
                    callback: function () {
                        l.bind(i)
            ...
            key: "bind", value: function (e) {
                var l = a("*[kit-filter=" + e.filter + "]"), i = l.find(".kit-cascader-show"), s = void 0;
                i.on("click", function (e) {
                    ...
                    layui.stope(t);
                    var c = {values: [], labels: [], objs: []}, r = a(this);
                    ...
                    u.length > 0 ? (r.siblings().find(".kit-item").removeClass("layui-this"), r.siblings().find(".kit-cascader-child").removeClass("layui-show"), u.addClass("layui-show")) : (l.find("li.layui-this").each(function (e, l) {
                        var i = a(this).attr("data-value"), n = a(this).attr("data-label");
                        c.values.push(i), c.labels.push(n), c.objs.push({value: i, label: n})
                        ...
                        elem: r,
                        obj: {value: r.attr("data-value"), label: r.attr("data-label")}
                    })
                })
            }
        }, {
