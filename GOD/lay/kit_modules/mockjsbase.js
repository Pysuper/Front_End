...
layui.define(function (exports) {
    ...
    py = this, qy = function () {
        return function (t) {
            ...
            var r, a = n(1), o = n(3), i = n(5), u = n(20), l = n(23), s = n(25);
            ...
            Handler.extend({
                array: function (t) {
                    ...
                    var e, n, r, a, o, i, u = {};
                    if (void 0 != t.rule.min) for (e = Util.keys(t.template), e = (e = Random.shuffle(e)).slice(0, t.rule.count), i = 0; i < e.length; i++) a = (r = e[i]).replace(Constant.RE_KEY, "$1"), t.context.path.push(a), t.context.templatePath.push(r), u[a] = Handler.gen(t.template[r], r, {
                        path: t.context.path,
                        templatePath: t.context.templatePath,
                        currentContext: u,
                        templateCurrentContext: t.template,
                        ...
                        for (e = e.concat(n), i = 0; i < e.length; i++) a = (r = e[i]).replace(Constant.RE_KEY, "$1"), t.context.path.push(a), t.context.templatePath.push(r), u[a] = Handler.gen(t.template[r], r, {
                            path: t.context.path,
                            templatePath: t.context.templatePath,
                            currentContext: u,
                            templateCurrentContext: t.template,
                ...
                _all: function () {
                    ...
                    var parts = Constant.RE_PLACEHOLDER.exec(_placeholder), key = parts && parts[1],
                    ...
                    "/" === t.charAt(0) ? a = [e.context.path[0]].concat(this.normalizePath(r)) : r.length > 1 && ((a = e.context.path.slice(0)).pop(), a = this.normalizePath(a.concat(r))), t = r[r.length - 1];
                    for (var o = e.context.root, i = e.context.templateRoot, u = 1; u < a.length - 1; u++) o = o[a[u]], i = i[a[u]];
            ...
            var n = {
                extend: function () {
                    var t, e, r, a, o, i = arguments[0] || {}, u = 1, l = arguments.length;
                    for (1 === l && (i = this, u = 0); l > u; u++) if (t = arguments[u]) for (e in t) r = i[e], i !== (a = t[e]) && void 0 !== a && (n.isArray(a) || n.isObject(a) ? (n.isArray(a) && (o = r && n.isArray(r) ? r : []), n.isObject(a) && (o = r && n.isObject(r) ? r : {}), i[e] = n.extend(o, a)) : i[e] = a);
                    return i
                }, each: function (t, e, n) {
                    var r, a;
                    if ("number" === this.type(t)) for (r = 0; t > r; r++) e(r, r); else if (t.length === +t.length) for (r = 0; r < t.length && !1 !== e.call(n, t[r], r, t); r++) ; else for (a in t) if (!1 === e.call(n, t[a], a, t)) break
                }, type: function (t) {
            ...
            t.exports = {
                boolean: function (t, e, n) {
                    ...
                    return e.alpha = e.lower + e.upper, e.undefined = e.lower + e.upper + e.number + e.symbol, (t = e[("" + t).toLowerCase()] || t).charAt(this.natural(0, t.length - 1))
                }, char: function (t) {
            ...
            (function (t) {
                t.exports = {
                    ...
                    dataImage: function (e, n) {
                        ...
                        var o = parseInt(e[0], 10), i = parseInt(e[1], 10),
                            u = this._brandColors[this.pick(this._brandNames())];
                        return r.width = o, r.height = i, a.textAlign = "center", a.textBaseline = "middle", a.fillStyle = u, a.fillRect(0, 0, o, i), a.fillStyle = "#FFF", a.font = "bold 14px sans-serif", a.fillText(n, o / 2, i / 2, o), r.toDataURL("image/png")
                    }
                }
            }).call(e, n(9)(t))
        }, function (t, e) {
            ...
            t.exports = {
                rgb2hsl: function (t) {
                    var e, n, r = t[0] / 255, a = t[1] / 255, o = t[2] / 255, i = Math.min(r, a, o),
                        u = Math.max(r, a, o), l = u - i;
                    return u == i ? e = 0 : r == u ? e = (a - o) / l : a == u ? e = 2 + (o - r) / l : o == u && (e = 4 + (r - a) / l), 0 > (e = Math.min(60 * e, 360)) && (e += 360), n = (i + u) / 2, [e, 100 * (u == i ? 0 : .5 >= n ? l / (u + i) : l / (2 - u - i)), 100 * n]
                }, rgb2hsv: function (t) {
                    var e, n, r = t[0], a = t[1], o = t[2], i = Math.min(r, a, o), u = Math.max(r, a, o), l = u - i;
                    return n = 0 === u ? 0 : l / u * 1e3 / 10, u == i ? e = 0 : r == u ? e = (a - o) / l : a == u ? e = 2 + (o - r) / l : o == u && (e = 4 + (r - a) / l), 0 > (e = Math.min(60 * e, 360)) && (e += 360), [e, n, u / 255 * 1e3 / 10]
                }, hsl2rgb: function (t) {
                    var e, n, r, a, o, i = t[0] / 360, u = t[1] / 100, l = t[2] / 100;
                    if (0 === u) return [o = 255 * l, o, o];
                    e = 2 * l - (n = .5 > l ? l * (1 + u) : l + u - l * u), a = [0, 0, 0];
                    for (var s = 0; 3 > s; s++) 0 > (r = i + 1 / 3 * -(s - 1)) && r++, r > 1 && r--, o = 1 > 6 * r ? e + 6 * (n - e) * r : 1 > 2 * r ? n : 2 > 3 * r ? e + (n - e) * (2 / 3 - r) * 6 : e, a[s] = 255 * o;
                    return a
                }, hsl2hsv: function (t) {
                    ...
                    var e = t[0] / 60, n = t[1] / 100, r = t[2] / 100, a = Math.floor(e) % 6, o = e - Math.floor(e),
                        i = 255 * r * (1 - n), u = 255 * r * (1 - n * o), l = 255 * r * (1 - n * (1 - o));
                    switch (r *= 255, a) {
                        case 0:
                            return [r, l, i];
                        case 1:
            ...
            t.exports = {
                capitalize: function (t) {
                    ...
                    for (var r = (t = t || []).slice(0), a = [], o = 0, i = r.length, u = 0; i > u; u++) o = this.natural(0, r.length - 1), a.push(r[o]), r.splice(o, 1);
                    switch (arguments.length) {
                        case 0:
                        case 1:
                            return a;
            ...
            var o = function () {
                function t(t, e, n, r, a) {
                    this.expected = t, this.found = e, this.offset = n, this.line = r, this.column = a, this.name = "SyntaxError", this.message = function (t, e) {
                        var n;
                        switch (t.length) {
                            case 0:
                                n = "end of input";
                    ...
                    SyntaxError: t, parse: function (e) {
                        ...
                        function s() {
                            ...
                            return t = pn, null !== (n = function () {
                                ...
                                if (t = pn, null === (s = pn, 94 === e.charCodeAt(pn) ? (f = B, pn++) : (f = null, 0 === xn && l(G)), null !== f && (fn = s, f = X()), null === f ? (pn = s, s = f) : s = f, n = s) && (n = I), null !== n) if (r = pn, xn++, a = p(), xn--, null === a ? r = I : (pn = r, r = O), null !== r) {
                                    for (a = [], null === (o = h()) && (o = c()); null !== o;) a.push(o), null === (o = h()) && (o = c());
                                ...
                                } else pn = t, t = O; else pn = t, t = O;
                                return t
                            }()) ? (r = pn, 124 === e.charCodeAt(pn) ? (a = j, pn++) : (a = null, 0 === xn && l(N)), null !== a && null !== (o = s()) ? r = a = [a, o] : (pn = r, r = O), null === r && (r = I), null !== r ? (fn = t, null === (n = z(n, r)) ? (pn = t, t = n) : t = n) : (pn = t, t = O)) : (pn = t, t = O), t
                        }

                        function c() {
                            var t, n, r, a, o, i, u, c, h, p, f, q, D, F, L, j, N, z, U, X, K, W, Y, $, J, V, Z, Q, tt;
                            return L = pn, 40 === e.charCodeAt(pn) ? (j = wt, pn++) : (j = null, 0 === xn && l(Ct)), null !== j ? (null === (Z = pn, e.substr(pn, 2) === St ? (Q = St, pn += 2) : (Q = null, 0 === xn && l(Tt)), null !== Q && null !== (tt = s()) ? (fn = Z, null === (Q = Ht(tt)) ? (pn = Z, Z = Q) : Z = Q) : (pn = Z, Z = O), N = Z) && null === ($ = pn, e.substr(pn, 2) === qt ? (J = qt, pn += 2) : (J = null, 0 === xn && l(Dt)), null !== J && null !== (V = s()) ? (fn = $, null === (J = Ft(V)) ? (pn = $, $ = J) : $ = J) : (pn = $, $ = O), N = $) && null === (K = pn, e.substr(pn, 2) === _t ? (W = _t, pn += 2) : (W = null, 0 === xn && l(Mt)), null !== W && null !== (Y = s()) ? (fn = K, null === (W = Pt(Y)) ? (pn = K, K = W) : K = W) : (pn = K, K = O), N = K) && (U = pn, null !== (X = s()) && (fn = U, X = At(X)), null === X ? (pn = U, U = X) : U = X, N = U), null !== N ? (41 === e.charCodeAt(pn) ? (z = kt, pn++) : (z = null, 0 === xn && l(Et)), null !== z ? (fn = L, null === (j = Rt(N)) ? (pn = L, L = j) : L = j) : (pn = L, L = O)) : (pn = L, L = O)) : (pn = L, L = O), null === (t = L) && null === (t = function () {
                                var t, n, r, a, o;
                                if (xn++, t = pn, 91 === e.charCodeAt(pn) ? (n = Ot, pn++) : (n = null, 0 === xn && l(It)), null !== n) if (94 === e.charCodeAt(pn) ? (r = B, pn++) : (r = null, 0 === xn && l(G)), null === r && (r = I), null !== r) {
                                    for (a = [], null === (o = d()) && (o = m()); null !== o;) a.push(o), null === (o = d()) && (o = m());
                                    null !== a ? (93 === e.charCodeAt(pn) ? (o = jt, pn++) : (o = null, 0 === xn && l(Nt)), null !== o ? (fn = t, null === (n = zt(r, a)) ? (pn = t, t = n) : t = n) : (pn = t, t = O)) : (pn = t, t = O)
                                } else pn = t, t = O; else pn = t, t = O;
                                return xn--, null === t && (n = null, 0 === xn && l(Lt)), t
                            }()) && (null === (D = pn, 46 === e.charCodeAt(pn) ? (F = Jt, pn++) : (F = null, 0 === xn && l(Vt)), null !== F && (fn = D, F = Zt()), null === F ? (pn = D, D = F) : D = F, n = D) && null === (null === (f = pn, e.substr(pn, 2) === ne ? (q = ne, pn += 2) : (q = null, 0 === xn && l(re)), null !== q && (fn = f, q = oe()), null === q ? (pn = f, f = q) : f = q, o = f) && null === (h = pn, e.substr(pn, 2) === ie ? (p = ie, pn += 2) : (p = null, 0 === xn && l(ue)), null !== p && (fn = h, p = le()), null === p ? (pn = h, h = p) : h = p, o = h) && null === (o = _()) && null === (o = g()) && null === (o = v()) && null === (o = x()) && null === (o = y()) && null === (o = b()) && null === (o = w()) && null === (o = C()) && null === (o = k()) && null === (o = E()) && null === (o = R()) && null === (o = A()) && null === (i = pn, 92 === e.charCodeAt(pn) ? (u = Ke, pn++) : (u = null, 0 === xn && l(We)), null !== u ? (Ye.test(e.charAt(pn)) ? (c = e.charAt(pn), pn++) : (c = null, 0 === xn && l($e)), null !== c ? (fn = i, null === (u = Je(c)) ? (pn = i, i = u) : i = u) : (pn = i, i = O)) : (pn = i, i = O), o = i) && null === (o = M()) && null === (o = P()) && null === (o = S()) && null === (o = T()) && (o = H()), n = o) && (xn++, r = pn, te.test(e.charAt(pn)) ? (a = e.charAt(pn), pn++) : (a = null, 0 === xn && l(ee)), null !== a && (fn = r, a = $t(a)), null === a ? (pn = r, r = a) : r = a, xn--, null === r && (a = null, 0 === xn && l(Qt)), n = r), t = n), t
                        }

                        function h() {
                            var t, e, n;
                            return t = pn, null !== (e = c()) && null !== (n = p()) ? (fn = t, null === (e = $(e, n)) ? (pn = t, t = e) : t = e) : (pn = t, t = O), t
                        }

                        function p() {
                            var t, n, r, a, o, i, u, s, c, h, p, d, m, g, v, x, y, b, w, C, k, E, R, A, _;
                            return xn++, t = pn, null === (C = pn, 123 === e.charCodeAt(pn) ? (k = Z, pn++) : (k = null, 0 === xn && l(Q)), null !== k && null !== (E = f()) ? (44 === e.charCodeAt(pn) ? (R = tt, pn++) : (R = null, 0 === xn && l(et)), null !== R && null !== (A = f()) ? (125 === e.charCodeAt(pn) ? (_ = nt, pn++) : (_ = null, 0 === xn && l(rt)), null !== _ ? (fn = C, null === (k = at(E, A)) ? (pn = C, C = k) : C = k) : (pn = C, C = O)) : (pn = C, C = O)) : (pn = C, C = O), o = C) && null === (x = pn, 123 === e.charCodeAt(pn) ? (y = Z, pn++) : (y = null, 0 === xn && l(Q)), null !== y && null !== (b = f()) ? (e.substr(pn, 2) === ot ? (w = ot, pn += 2) : (w = null, 0 === xn && l(it)), null !== w ? (fn = x, null === (y = ut(b)) ? (pn = x, x = y) : x = y) : (pn = x, x = O)) : (pn = x, x = O), o = x) && null === (d = pn, 123 === e.charCodeAt(pn) ? (m = Z, pn++) : (m = null, 0 === xn && l(Q)), null !== m && null !== (g = f()) ? (125 === e.charCodeAt(pn) ? (v = nt, pn++) : (v = null, 0 === xn && l(rt)), null !== v ? (fn = d, null === (m = lt(g)) ? (pn = d, d = m) : d = m) : (pn = d, d = O)) : (pn = d, d = O), o = d) && null === (h = pn, 43 === e.charCodeAt(pn) ? (p = st, pn++) : (p = null, 0 === xn && l(ct)), null !== p && (fn = h, p = ht()), null === p ? (pn = h, h = p) : h = p, o = h) && null === (s = pn, 42 === e.charCodeAt(pn) ? (c = pt, pn++) : (c = null, 0 === xn && l(ft)), null !== c && (fn = s, c = dt()), null === c ? (pn = s, s = c) : s = c, o = s) && (i = pn, 63 === e.charCodeAt(pn) ? (u = mt, pn++) : (u = null, 0 === xn && l(gt)), null !== u && (fn = i, u = vt()), null === u ? (pn = i, i = u) : i = u, o = i), null !== (n = o) ? (63 === e.charCodeAt(pn) ? (a = mt, pn++) : (a = null, 0 === xn && l(gt)), null === (r = a) && (r = I), null !== r ? (fn = t, null === (n = V(n, r)) ? (pn = t, t = n) : t = n) : (pn = t, t = O)) : (pn = t, t = O), xn--, null === t && (n = null, 0 === xn && l(J)), t
                        }

                        function f() {
                            var t, n, r;
                            if (t = pn, n = [], xt.test(e.charAt(pn)) ? (r = e.charAt(pn), pn++) : (r = null, 0 === xn && l(yt)), null !== r) for (; null !== r;) n.push(r), xt.test(e.charAt(pn)) ? (r = e.charAt(pn), pn++) : (r = null, 0 === xn && l(yt)); else n = O;
                            return null !== n && (fn = t, n = bt(n)), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function d() {
                            var t, n, r, a;
                            return xn++, t = pn, null !== (n = m()) ? (45 === e.charCodeAt(pn) ? (r = Bt, pn++) : (r = null, 0 === xn && l(Gt)), null !== r && null !== (a = m()) ? (fn = t, null === (n = Xt(n, a)) ? (pn = t, t = n) : t = n) : (pn = t, t = O)) : (pn = t, t = O), xn--, null === t && (n = null, 0 === xn && l(Ut)), t
                        }

                        function m() {
                            var t, n, r, a, o, i;
                            return xn++, null === (o = pn, e.substr(pn, 2) === ne ? (i = ne, pn += 2) : (i = null, 0 === xn && l(re)), null !== i && (fn = o, i = ae()), null === i ? (pn = o, o = i) : o = i, a = o) && null === (a = _()) && null === (a = g()) && null === (a = v()) && null === (a = x()) && null === (a = y()) && null === (a = b()) && null === (a = w()) && null === (a = C()) && null === (a = k()) && null === (a = E()) && null === (a = R()) && null === (a = A()) && null === (a = M()) && null === (a = P()) && null === (a = S()) && null === (a = T()) && (a = H()), null === (t = a) && (n = pn, Wt.test(e.charAt(pn)) ? (r = e.charAt(pn), pn++) : (r = null, 0 === xn && l(Yt)), null !== r && (fn = n, r = $t(r)), null === r ? (pn = n, n = r) : n = r, t = n), xn--, null === t && 0 === xn && l(Kt), t
                        }

                        function g() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === se ? (n = se, pn += 2) : (n = null, 0 === xn && l(ce)), null !== n && (fn = t, n = he()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function v() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === pe ? (n = pe, pn += 2) : (n = null, 0 === xn && l(fe)), null !== n && (fn = t, n = de()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function x() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === me ? (n = me, pn += 2) : (n = null, 0 === xn && l(ge)), null !== n && (fn = t, n = ve()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function y() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === xe ? (n = xe, pn += 2) : (n = null, 0 === xn && l(ye)), null !== n && (fn = t, n = be()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function b() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === we ? (n = we, pn += 2) : (n = null, 0 === xn && l(Ce)), null !== n && (fn = t, n = ke()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function w() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === Ee ? (n = Ee, pn += 2) : (n = null, 0 === xn && l(Re)), null !== n && (fn = t, n = Ae()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function C() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === _e ? (n = _e, pn += 2) : (n = null, 0 === xn && l(Me)), null !== n && (fn = t, n = Pe()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function k() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === Se ? (n = Se, pn += 2) : (n = null, 0 === xn && l(Te)), null !== n && (fn = t, n = He()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function E() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === qe ? (n = qe, pn += 2) : (n = null, 0 === xn && l(De)), null !== n && (fn = t, n = Fe()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function R() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === Le ? (n = Le, pn += 2) : (n = null, 0 === xn && l(Oe)), null !== n && (fn = t, n = Ie()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function A() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === je ? (n = je, pn += 2) : (n = null, 0 === xn && l(Ne)), null !== n && (fn = t, n = ze()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function _() {
                            var t, n, r;
                            return t = pn, e.substr(pn, 2) === Ue ? (n = Ue, pn += 2) : (n = null, 0 === xn && l(Be)), null !== n ? (e.length > pn ? (r = e.charAt(pn), pn++) : (r = null, 0 === xn && l(Ge)), null !== r ? (fn = t, null === (n = Xe(r)) ? (pn = t, t = n) : t = n) : (pn = t, t = O)) : (pn = t, t = O), t
                        }

                        function M() {
                            var t, n, r, a;
                            if (t = pn, e.substr(pn, 2) === Ve ? (n = Ve, pn += 2) : (n = null, 0 === xn && l(Ze)), null !== n) {
                                if (r = [], Qe.test(e.charAt(pn)) ? (a = e.charAt(pn), pn++) : (a = null, 0 === xn && l(tn)), null !== a) for (; null !== a;) r.push(a), Qe.test(e.charAt(pn)) ? (a = e.charAt(pn), pn++) : (a = null, 0 === xn && l(tn)); else r = O;
                        ...
                        function P() {
                            ...
                            if (t = pn, e.substr(pn, 2) === nn ? (n = nn, pn += 2) : (n = null, 0 === xn && l(rn)), null !== n) {
                                if (r = [], an.test(e.charAt(pn)) ? (a = e.charAt(pn), pn++) : (a = null, 0 === xn && l(on)), null !== a) for (; null !== a;) r.push(a), an.test(e.charAt(pn)) ? (a = e.charAt(pn), pn++) : (a = null, 0 === xn && l(on)); else r = O;
                        ...
                        function T() {
                            var t, n;
                            return t = pn, e.substr(pn, 2) === Ve ? (n = Ve, pn += 2) : (n = null, 0 === xn && l(Ze)), null !== n && (fn = t, n = hn()), null === n ? (pn = t, t = n) : t = n, t
                        }

                        function H() {
                            var t, n, r;
                            return t = pn, 92 === e.charCodeAt(pn) ? (n = Ke, pn++) : (n = null, 0 === xn && l(We)), null !== n ? (e.length > pn ? (r = e.charAt(pn), pn++) : (r = null, 0 === xn && l(Ge)), null !== r ? (fn = t, null === (n = $t(r)) ? (pn = t, t = n) : t = n) : (pn = t, t = O)) : (pn = t, t = O), t
                        }

                        var q, D = arguments.length > 1 ? arguments[1] : {}, F = {regexp: s}, L = s, O = null, I = "",
                            j = "|", N = '"|"', z = function (t, e) {
                            ...
                            }, J = "Quantifier", V = function (t, e) {
                                return e && (t.greedy = !1), t
                            }, Z = "{", Q = '"{"', tt = ",", et = '","', nt = "}", rt = '"}"', at = function (t, e) {
                                return new a(t, e)
                            }, ot = ",}", it = '",}"', ut = function (t) {
                                return new a(t, 1 / 0)
                            }, lt = function (t) {
                                ...
                                return new a(0, 1)
                            }, xt = /^[0-9]/, yt = "[0-9]", bt = function (t) {
                                return +t.join("")
                            }, wt = "(", Ct = '"("', kt = ")", Et = '")"', Rt = function (t) {
                                return t
                            }, At = function (t) {
                                return new function (t) {
                                    r.call(this, "capture-group"), this.index = u[this.offset] || (u[this.offset] = i++), this.body = t
                                }(t)
                            }, _t = "?:", Mt = '"?:"', Pt = function (t) {
                        ...
                        }(vn), fn = Math.max(pn, gn), new t(vn, fn < e.length ? e.charAt(fn) : null, fn, o(fn).line, o(fn).column)
                    }
                }
            }(), i = 1, u = {};
            t.exports = o
            ...
            var a = n(3), o = n(5), i = {extend: a.extend}, u = r(97, 122), l = r(65, 90), s = r(48, 57),
                c = r(32, 47) + r(58, 64) + r(91, 96) + r(123, 126), h = r(32, 126), p = " \f\n\r\t\v \u2028\u2029",
                f = {
                    "\\w": u + l + s + "_", "\\W": c.replace("_", ""), "\\s": p, "\\S": function () {
            ...
            i.gen = function (t, e, n) {
                ...
                token: function (t, e, n) {
                    ...
                    for (var r, a = h, i = 0; i < t.body.length; i++) switch ((r = t.body[i]).type) {
                        case"literal":
                            a = a.replace(r.body, "");
                            break;
                        case"range":
            ...
            t.exports = function t(e, n, i) {
                ...
                switch (u.path = i.slice(0), u.path.push(void 0 === n ? "ROOT" : u.name), u.type) {
                    case"array":
                        u.items = [], a.each(e, function (e, n) {
                            u.items.push(t(e, n, u.path))
                        });
                        break;
                    case"object":
                        u.properties = [], a.each(e, function (e, n) {
            ...
            var a = n(2), o = n(3), i = n(23), u = {
                diff: function (t, e, n) {
                    ...
                    var o, i = r.length, u = t.rule, s = t.type;
                    ...
                    switch (s) {
                        ...
                        case"boolean":
                            break;
                        case"string":
                            o = (o = e.match(new RegExp(t.template, "g"))) ? o.length : 0, void 0 !== u.min && void 0 !== u.max && (l.greaterThanOrEqualTo("repeat count", t.path, o, u.min, r), l.lessThanOrEqualTo("repeat count", t.path, o, u.max, r)), void 0 !== u.min && void 0 === u.max && l.equal("repeat count", t.path, o, u.min, r);
                            break;
                        case"regexp":
                            o = (o = e.match(new RegExp(t.template.source.replace(/^\^|\$$/g, ""), "g"))) ? o.length : 0, void 0 !== u.min && void 0 !== u.max && (l.greaterThanOrEqualTo("repeat count", t.path, o, u.min, r), l.lessThanOrEqualTo("repeat count", t.path, o, u.max, r)), void 0 !== u.min && void 0 === u.max && l.equal("repeat count", t.path, o, u.min, r)
                    }
                    return r.length === i
                }, properties: function (t, e, n, r) {
                    var a = r.length, i = t.rule, u = o.keys(e);
                    if (t.properties) {
                ...
                message: function (t) {
                    ...
                    if (n !== r) return !0;
                    var i = {path: e, type: t, actual: n, expected: r, action: "is not equal to", message: o};
                    return i.message = l.message(i), a.push(i), !1
                }, greaterThan: function (t, e, n, r, a, o) {
                    if (n > r) return !0;
                    var i = {path: e, type: t, actual: n, expected: r, action: "is greater than", message: o};
                    return i.message = l.message(i), a.push(i), !1
                    ...
                    if (r >= n) return !0;
                    var i = {path: e, type: t, actual: n, expected: r, action: "is less than or equal to", message: o};
                    return i.message = l.message(i), a.push(i), !1
                }
            };
            ...
            r._settings = {timeout: "10-100"}, r.setup = function (t) {
            ...
            }, a.extend(r, o), a.extend(r.prototype, o), r.prototype.mock = !0, r.prototype.match = !1, a.extend(r.prototype, {
                open: function (t, e, n, o, s) {
                    ...
                    if (p) this.match = !0, this.custom.template = p, this.readyState = r.OPENED, this.dispatchEvent(new Event("readystatechange")); else {
                        var f = function () {
                            function t() {
                                try {
                            ...
                            var e, n,
                                r = (e = location.href, n = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/.exec(e.toLowerCase()) || [], /^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(n[1]));
                            return window.ActiveXObject ? !r && t() || function () {
                                try {
                    ...
                    function e() {
                        var t, e;
                        n.readyState = r.HEADERS_RECEIVED, n.dispatchEvent(new Event("readystatechange")), n.readyState = r.LOADING, n.dispatchEvent(new Event("readystatechange")), n.status = 200, n.statusText = s[200], n.response = n.responseText = JSON.stringify((t = n.custom.template, e = n.custom.options, a.isFunction(t.template) ? t.template(e) : r.Mock.mock(t.template)), null, 4), n.readyState = r.DONE, n.dispatchEvent(new Event("readystatechange")), n.dispatchEvent(new Event("load")), n.dispatchEvent(new Event("loadend"))
                    }
    ...
    }, "object" == (void 0 === exports ? "undefined" : _typeof(exports)) && "object" == ("undefined" == typeof module ? "undefined" : _typeof(module)) ? module.exports = qy() : "function" == typeof define && define.amd ? define([], qy) : "object" == (void 0 === exports ? "undefined" : _typeof(exports)) ? exports.Mock = qy() : py.Mock = qy(), exports("mockjsbase", Mock)
});
